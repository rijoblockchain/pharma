...
func (r *Retailer) CreatePO(ctx contractapi.TransactionContextInterface, poInfo []byte) (*distributor.PurchaseOrder, error) {
	type POData struct {
...
func (r *Retailer) RetailDrug(ctx contractapi.TransactionContextInterface, retailInfo []byte) error {
	type Retail struct {
		DrugName		string `json:"drugName"`
